...
/// Deletes the owner account's Spotify import — the counterpart to the
  ...
  Widget _buildContent() {
    switch (_phase) {
      case _RemovePhase.confirm:
        return const Text(
          'Every play imported from Spotify will be removed from the owner '
          'account. Listening Ariami tracked itself is kept, and you can '
          'import the same export again later.',
        );
